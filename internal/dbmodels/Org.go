...
var ORGWhere = struct {
	...
	ID:       whereHelperint64{field: "\"Org\".\"id\""},
	Name:     whereHelpernull_String{field: "\"Org\".\"name\""},
	Location: whereHelpernull_String{field: "\"Org\".\"location\""},
}
...
var (
	orgAllColumns            = []string{"id", "name", "location"}
	orgColumnsWithoutDefault = []string{"id"}
	orgColumnsWithDefault    = []string{"name", "location"}
